...
namespace TarefasApp.Controllers
{
    public class TarefasController : Controller
    {
        ...
        {
            var context = _context.Tarefa.Include(t => t.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioId,Data,Descricao,Status")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UsuarioId,Data,Descricao,Status")] Tarefa tarefa)
        {
            if (id != tarefa.Id)
            {
                return NotFound();
